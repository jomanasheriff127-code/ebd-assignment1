...
Hero: Jomana the Mage
Student ID: 16001137
GitHub account: jomanasheriff127-code

A **Sand Kraken** bars the way near **Alexandria**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By Alexandria, the Sand Kraken shatters!"
